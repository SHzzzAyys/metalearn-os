...
- `洞察报告`: Brier score, calibration evidence thresholds, reliability curve, Brier trend, scoped material/tag/concept insights, overconfidence, high-confidence error rate, passive-learning risk, weak tags, tag-level overconfidence, and explanation gap types.
...
- user-pinned study views on the home launcher, persisted locally, manageable in Settings, and included in JSON backup/restore;
